          ...
          <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100">
            <div>
              ...
              <p className="text-xs text-gray-400 mt-0.5">
                Detail absensi bulanan — {MONTHS_ID[now.getMonth()]} {now.getFullYear()}
              </p>
            </div>
            <div className="flex items-center gap-2">
              <button className="inline-flex items-center gap-1.5 border border-gray-200 text-gray-600 text-xs font-medium px-3 py-2 rounded-lg hover:bg-gray-50 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <button className="inline-flex items-center gap-1.5 bg-primary-800 text-white text-xs font-medium px-3 py-2 rounded-lg hover:bg-primary-900 transition-colors">
                <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
